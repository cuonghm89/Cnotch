        ...
        ZStack {
            ...
            case .accessibilityPermission:
                PermissionRequestView(
                    ...
                    description: "Accessibility access allows CNotch to replace macOS volume and brightness HUDs with dynamic notch overlays.",
            ...
            case .bluetoothPermission:
                PermissionRequestView(
                    ...
                    description: "CNotch can show when your Bluetooth audio accessories connect, including their battery level when available.",
