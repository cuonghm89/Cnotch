...
final class XPCHelperClient: NSObject {
    ...
    #if DEBUG
    private let serviceName = "com.cuonghm89.cnotch.debug.CNotchXPCHelper"
#else
    private let serviceName = "com.cuonghm89.cnotch.CNotchXPCHelper"
#endif
    
    private var remoteService: RemoteXPCService<CNotchXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<CNotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<CNotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: CNotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<CNotchXPCHelperProtocol>? {
        remoteService
    }
